...
{
    return collect($scores)->map(function (Collection $result): array {
...
const EXPECTED_BASELINE = [
    [
        'team' => 'team 1', 'played' => 'team 2',
        'won' => 14, 'lost' => 0, 'for' => 121, 'against' => 89,
        'games_played' => 14, 'last_game_won' => false,
        'percentage' => 73, 'rank' => 1, 'finals' => 15, 'max_games' => 15,
        'last_result' => ['score1' => 8, 'score2' => 7],
    ],
    [
        'team' => 'team 2', 'played' => 'team 1',
        'won' => 8, 'lost' => 6, 'for' => 105, 'against' => 105,
        'games_played' => 15, 'last_game_won' => false,
        'percentage' => 50, 'rank' => 2, 'finals' => 15, 'max_games' => 15,
        'last_result' => ['score1' => 7, 'score2' => 8],
    ],
    [
        'team' => 'team 3', 'played' => 'team 2',
        'won' => 2, 'lost' => 7, 'for' => 65, 'against' => 70,
        'games_played' => 10, 'last_game_won' => false,
        'percentage' => 21, 'rank' => 3, 'finals' => 10, 'max_games' => 15,
        'last_result' => ['score1' => 7, 'score2' => 8],
    ],
    [
        'team' => 'team 4', 'played' => 'team 1',
        'won' => 1, 'lost' => 8, 'for' => 62, 'against' => 73,
        'games_played' => 10, 'last_game_won' => false,
        'percentage' => 17, 'rank' => 4, 'finals' => 10, 'max_games' => 15,
        'last_result' => ['score1' => 7, 'score2' => 8],
    ],
    [
        'team' => 'team 5', 'played' => 'team 2',
        'won' => 0, 'lost' => 4, 'for' => 22, 'against' => 38,
        'games_played' => 5, 'last_game_won' => false,
        'percentage' => 4, 'rank' => 5, 'finals' => 5, 'max_games' => 15,
        'last_result' => ['score1' => 7, 'score2' => 8],
    ],
];
...
it('orders the standings by descending percentage', function (): void {
    ...
    expect($percentages)->toBe([73, 50, 21, 17, 4])
        ->and($percentages)->toEqual(collect($percentages)->sortDesc()->values()->all());
});
