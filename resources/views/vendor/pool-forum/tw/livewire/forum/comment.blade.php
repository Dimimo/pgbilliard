<div class="flex justify-between items-base py-3 my-3 md:mx-4">
    <div class="mt-4 w-16 hidden md:block">
        <div class="bg-primary-500 font-semibold inline-block p-6 rounded-full text-white">
            {{Str::of($avatar)->upper()}}
        </div>
    </div>
        ...
        <form id="post-form">
            <div class="mb-4">
                ...
                <textarea
                    ...
                    class=" w-full border border-gray-200 active:outline-none focus:outline-none focus:shadow-outline-blue p-6 rounded"
                    name="content"
