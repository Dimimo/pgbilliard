    ...
    <x-forms.sub-title title="{{__('The players')}}">
        <div class="mt-4">
                    ...
                    <div class="basis-9/12" x-cloak x-show="edit">
                        ...
                        >
                            ...
                            <input
                                ...
                                type="text"
                                wire:model="user_form.contact_nr"
                            />
            ...
            <div class="m-2 block border border-green-400 bg-green-100 p-4 text-center text-lg">
                <p>
                    <span class="font-semibold underline">Hint</span>
                    : click on
                ...
                <p>
                    ...
                    will remove the player. A warning is given, but it's easy to reassign any
                    player.
                </p>
                <p>
                    If the captain has no phone number, the contact number of the venue's owner is
                    shown.
                </p>
                <p>
                    <span class="font-semibold">Every player</span>
    ...
    @if (!$max_reached && $show_new_player_form)
        <x-forms.sub-title title="{{__('Add a player to the team')}}">
            ...
            <div class="flex justify-center p-2 text-sm italic text-gray-500">
                If the player you are looking for is not in the list, (s)he is probably assigned to
                another team or is new.
            </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center p-2">
                        ...
                        <input
                            id="user_form.name"
                            type="text"
                            wire:model.live.debounce.500ms="user_form.name"
                        />
