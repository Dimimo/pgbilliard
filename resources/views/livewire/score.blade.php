<div>
    @if($isAndroid)
        <div class="mx-auto mb-4 border-2 border-green-500 bg-stone-50 rounded-xl p-4">
            <div class="mb-2 text-lg text-green-900">
                To Android users
                <a
            ...
            <div>
                ...
                >
                    ...
                    Help us getting the Puerto Galera Billiard League app from Google Store accepted to production
            ...
            <tr>
                ...
                <th @class([
                    ...
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                        class="inline-block w-5 h-5 fill-red-600 mb-1"
                    >
                        <path
                ...
                <th @class([
                    ...
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512"
                        class="inline-block w-5 h-5 fill-orange-500 mb-1"
                    >
                        <path
                ...
                <th title={{__('Percentage')}} @class([
                    ...
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 384 512"
                        class="inline-block w-5 h-5 fill-indigo-500 mb-1"
                    >
                        <path
                ...
                <th title={{__('Number of games participated')}} @class([
                    ...
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 512"
                        class="inline-block w-5 h-5 fill-blue-800 mb-1"
                    >
                        <path
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 448 512"
                                            class="inline-block w-3 h-3 fill-gray-600"
                                        >
                                            <path
