...
<section>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-forms.text-input wire:model="password" id="password" name="password" type="password" class="mt-1 block w-full"
        ...
        <div>
            ...
            <x-forms.text-input wire:model="password_confirmation" id="password_confirmation" name="password_confirmation" type="password"
