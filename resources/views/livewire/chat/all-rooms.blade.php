<div class="rounded-lg bg-gray-100 p-2 shadow-lg md:p-4">
    <h2 class="m-4 mt-4 pl-4 text-xl font-semibold">Public Chat</h2>
    ...
    <h2 class="m-4 mt-4 pl-4 text-xl font-semibold">{{ __('Private Chat') }}</h2>
    @forelse ($private_rooms as $private_room)
        <div class="flex justify-between">
            <div>
                ...
                ({{ $private_room->users_count }} {{ __('invited') }})
            </div>
