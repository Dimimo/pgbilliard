    ...
    @if($teams)
        <div class="border border-gray-500 p-0 m-2">
            ...
            @foreach($teams as $key => $team)
                <div class="w-full block my-2 pl-2" wire:key="{{ $team->id }}">
                    ...
                    <select class="inline-block" id="team_{{$key}}_user_id" wire:model.defer="teams.{{ $key }}.user_id">
                        <option readonly>Select captain...</option>
            ...
            @endforeach
            <div class="w-full flex justify-start mt-5 p-4">
