    ...
    <form wire:submit="save">
        <div class="my-4">
            ...
            <input
                type="text"
                id="name"
                class="block rounded-md border-blue-300 p-3 shadow-sm border-1 focus:outline-none sm:text-sm"
        ...
        <div class="my-4">
            <label for="captain_id" class="block">
                If known, you may select the captain
            </label>
