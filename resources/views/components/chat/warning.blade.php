<div class="my-4 border border-green-500 bg-green-100 p-4">
    <div class="">
        Good news, kind of. I found a way to make the chat work. It's a bit unconventional. In the
        background it reloads the chat messages every 2 seconds. A bad idea on a very busy server.
        But in our environment is suits our needs.
    </div>
    {{--
        <div class="mb-2">
