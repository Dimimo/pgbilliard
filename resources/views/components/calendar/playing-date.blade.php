...
<div class="flex items-center justify-between">
    ...
    <div class="flex items-center">
        <input id="regular" name="regular" type="checkbox"
    ...
    <label>
        <input name="title" type="text" class="bg-gray-100 w-auto text-sm px-2 rounded-md outline-blue-500" placeholder="Title?"/>
    </label>
</div>
@error('event.date_id')
