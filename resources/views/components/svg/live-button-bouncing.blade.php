...
<div class="flex justify-center items-center mt-6">
    <a
        ...
        class="relative flex items-center justify-center px-6 py-3 bg-green-600 text-white text-lg font-semibold rounded-full transform hover:scale-105 transition-transform duration-200"
        wire:navigate
    >
        <span class="absolute inset-0 rounded-full bg-green-500 opacity-50 animate-ping"></span>
        <span class="relative z-10">Now Live</span>
        <svg
            class="w-7 h-7 ml-2 relative z-10"
