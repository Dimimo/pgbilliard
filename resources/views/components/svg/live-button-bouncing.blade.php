...
<div class="mt-6 flex items-center justify-center">
    <a
        ...
        class="relative flex transform items-center justify-center rounded-full bg-green-600 px-6 py-3 text-lg font-semibold text-white transition-transform duration-200 hover:scale-105"
        wire:navigate
    >
        <span class="absolute inset-0 animate-ping rounded-full bg-green-500 opacity-50"></span>
        <span class="relative z-10">Now Live</span>
        <svg
            class="relative z-10 ml-2 h-7 w-7"
