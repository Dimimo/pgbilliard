...
<div class="text-justify">
    @if($new === true)
        ...
        <div class="my-2">
            ...
            automatically selected. The location can be changed, if necessary. A warning is given just in case.
            Click 'create this game' and done.
        </div>
    ...
    <div class="my-2">
        ...
        Games that are <span class="font-bold">confirmed</span> can not be deleted.
    </div>
    ...
    <div class="my-2">
        ...
        If you want to skip a week (holidays for example), create 2 new dates and delete the holiday later. <br>
    ...
    <div class="my-2">
        A Season can be deleted if it has no dates. If there is only one date left without games, you can delete the season.
        Just in case you make a mistake with the opening tag of a new season (in this case Season {{ $dates->first()->season->cycle }}).
    </div>
    ...
    @else
        ...
        <div class="my-2">
            ...
            <x-forms.nav-link :active="true" href="{{ route('calendar') }}" class="text-lg" wire:navigate>Calendar</x-forms.nav-link>
            .
        </div>
