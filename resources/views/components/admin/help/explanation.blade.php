<div class="flex flex-col space-y-3">
    <div>
        ...
        A list of teams appears on the bottom (select team). Select a team appropriate for the new Season. It will copy the name, venue and
    ...
    <div>
        ...
        or it can be added later by an Admin.
