<x-forms.dropdown width="48">
    <x-slot name="trigger">
        <button
            class="inline-flex cursor-pointer items-center rounded-md border border-transparent bg-transparent px-1 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none"
