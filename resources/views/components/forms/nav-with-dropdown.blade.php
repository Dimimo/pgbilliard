<header class='shadow-md bg-white font-[sans-serif]'>
    <section class='flex items-center lg:justify-center relative py-3 sm:px-10 px-4 border-gray-200 border-b min-h-[75px]'>
        ...
        <a href="javascript:void(0)">
            <img src="https://readymadeui.com/readymadeui.svg" alt="logo" class='md:w-[170px] w-36'/>
        </a>
        <div class="absolute sm:right-10 right-4 flex items-center">
          <span class="relative sm:mr-8 mr-6">
            <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="cursor-pointer fill-[#333] hover:fill-[#007bff] inline-block"
                 viewBox="0 0 64 64">
              <path
    ...
    <div class='flex flex-wrap items-center justify-center px-10 py-2 relative min-h-[48px]'>
        <div class='flex ml-auto lg:order-1 lg:hidden relative z-50'>
            <button class='ml-7'>
        ...
        <ul class='flex lg:space-x-10 max-lg:space-y-3 max-lg:block max-lg:w-full max-lg:mt-2'>
            ...
            <li class='group max-lg:border-b max-lg:py-2 relative'>
                ...
                <ul
                    ...
                    <li class='border-b py-3'>
                        <a href='javascript:void(0)' class='hover:text-[#007bff] hover:fill-[#007bff] text-gray-600 font-semibold text-[15px] block'>
