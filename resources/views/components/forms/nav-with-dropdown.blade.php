<header class="bg-white font-[sans-serif] shadow-md">
    <section
        class="relative flex min-h-[75px] items-center border-b border-gray-200 px-4 py-3 sm:px-10 lg:justify-center"
    >
        <div class="absolute left-10 z-50 flex rounded bg-gray-100 px-4 py-3 max-lg:hidden">
            <svg
        ...
        <div class="absolute right-4 flex items-center sm:right-10">
            <span class="relative mr-6 sm:mr-8">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20px"
    ...
    <div class="relative flex min-h-[48px] flex-wrap items-center justify-center px-10 py-2">
        ...
        <ul class="flex max-lg:mt-2 max-lg:block max-lg:w-full max-lg:space-y-3 lg:space-x-10">
            ...
            <li class="group relative max-lg:border-b max-lg:py-2">
                <a
                    href="javascript:void(0)"
                ...
                <ul
                    class="absolute left-0 z-50 hidden min-w-[250px] space-y-2 bg-white px-6 pb-4 pt-6 shadow-lg group-hover:block max-lg:top-8 lg:top-5"
                >
