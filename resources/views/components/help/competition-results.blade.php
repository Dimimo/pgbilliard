<div class="text-justify">
    ...
    <p class="mb-4">
        ...
        <span class="font-mono">
            (((Games Won / TG) x 100) + (Individual Games Won / (TG x 15) x 100) / 2 * factor)
        </span>
    </p>
    <p class="mb-4">
        The
        ...
        percentage. The runner-up gets 15% extra. All other teams get a factor of 1.
    </p>
    <p class="mb-4">BYE games are excluded in any calculation as they are not considered a game.</p>
    <p class="mb-4">
