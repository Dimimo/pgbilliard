<div class="text-justify">
    ...
    <div class="mb-4">
        <span class="font-bold">Teams and where they play</span> are obvious. The number next to it are the number of
        players added to the team. In the future, it should be at least 4.
    </div>
    <div class="mb-4">
        Finally, the Captain and the contact number. If the Captain is not set or the Captain didn't fill in the contact number,
    ...
    <div class="mb-4 border-2 border-gray-500 bg-gray-100 p-4">
        ...
        <div>
            ...
            <a href="{{ route('rank') }}" class="inline-block text-blue-800 link" wire:navigate>the individual scoreboard</a>.
        </div>
    </div>
    <div class="mb-6">
    ...
    <div class="italic">
        (some players in the proposed list are not with us anymore; at the startup of the new website I had no other choice
        but to add everybody from the previous database; this will change after the first 2025 Season)
    </div>
</div>
