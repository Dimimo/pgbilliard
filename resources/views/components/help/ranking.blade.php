<div class="text-justify">
    <div class="mb-4 font-bold">
        <span class="underline">Disclaimer</span>: this feature is still experimental and open to changes.
    </div>
    <div class="mb-4">
    ...
    <div class="mb-4 flex">
        ...
        <div class="flex-1">
            <div>
                The percentage is calculated as following <br>
            ...
            <div>
                As you see, it's not perfect. A work in progress. If a player has 1 game every week and wins, it results in 100%.
                We'll have to find a way to avoid such scenario and yet keep it honest for every player involved. A logarithmic
                multiplier maybe.
            </div>
        </div>
    </div>
