<div class="overflow-x-auto">
    <table class="min-w-full bg-white font-[sans-serif]">
        ...
        <tr class="odd:bg-blue-50">
            ...
            <td class="px-6 py-3 text-sm">
                <div class="flex items-center cursor-pointer">
                    <img src='https://readymadeui.com/profile_4.webp' class="w-9 h-9 rounded-full shrink-0"  alt=""/>
                    <div class="ml-4">
        ...
        <tr class="odd:bg-blue-50">
            ...
            <td class="px-6 py-3 text-sm">
                <div class="flex items-center cursor-pointer">
                    <img src='https://readymadeui.com/profile_5.webp' class="w-9 h-9 rounded-full shrink-0"  alt=""/>
                    <div class="ml-4">
        ...
        <tr class="odd:bg-blue-50">
            ...
            <td class="px-6 py-3 text-sm">
                <div class="flex items-center cursor-pointer">
                    <img src='https://readymadeui.com/profile_3.webp' class="w-9 h-9 rounded-full shrink-0"  alt=""/>
                    <div class="ml-4">
        ...
        <tr class="odd:bg-blue-50">
            ...
            <td class="px-6 py-3 text-sm">
                <div class="flex items-center cursor-pointer">
                    <img src='https://readymadeui.com/profile_2.webp' class="w-9 h-9 rounded-full shrink-0"  alt=""/>
                    <div class="ml-4">
        ...
        <tr class="odd:bg-blue-50">
            ...
            <td class="px-6 py-3 text-sm">
                <div class="flex items-center cursor-pointer">
                    <img src='https://readymadeui.com/profile_6.webp' class="w-9 h-9 rounded-full shrink-0"  alt=""/>
                    <div class="ml-4">
