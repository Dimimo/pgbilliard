            ...
            <div class="bg-white">
                ...
                <table class="table-collapse my-2 min-w-full bg-transparent md:my-4">
                    <thead class="whitespace-nowrap">
                        <tr>
                            <th class="bg-gray-300 p-2 text-center text-gray-900 animate-pulse rounded">#</th>
                            <th class="bg-blue-300 p-2 text-left text-gray-900 animate-pulse rounded">Team</th>
                            <th class="bg-amber-300 p-2 text-left text-gray-900 animate-pulse rounded">Last game</th>
                            <th class="bg-yellow-200 p-2 text-center text-gray-900 animate-pulse rounded">Score</th>
                        </tr>
                   </thead>
                   <tbody class="whitespace-nowrap">
                        <tr class="h-8">
                            <td class="bg-gray-200 p-2 text-center text-gray-900 animate-pulse">
