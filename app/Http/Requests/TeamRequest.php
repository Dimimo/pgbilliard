...
class TeamRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'min:2', 'max:' . Constants::TEAMCHARS],
            'venue_id' => ['required', 'exists:App\Models\Venue,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.max' =>
                'A team name can\'t be longer than ' . Constants::TEAMCHARS . ' characters',
