...
class VenueRequest extends FormRequest
{
    public function rules(Venue $venue): array
    {
        return [
            ...
            'contact_name' => ['nullable', 'string', 'max:' . Constants::USERCHARS],
            'contact_nr' => ['nullable', 'string', 'max:' . Constants::PHONECHARS],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.max' =>
                'The name of a venue can not be longer than ' .
                Constants::VENUECHARS .
                ' characters',
            ...
            'contact_name.max' =>
                'The contact name can not be longer than ' . Constants::USERCHARS . ' characters',
            'contact_nr.max' =>
                'The contact number can not be longer than ' .
                Constants::PHONECHARS .
                ' characters',
